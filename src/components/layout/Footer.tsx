      ...
      <div className="mx-auto max-w-7xl px-4 py-12 sm:px-6 lg:px-8">
        <div className="grid gap-8 sm:grid-cols-2 lg:grid-cols-4">
          ...
          <div>
            ...
            <ul className="space-y-2">
              <li>
                <Link href="/reports" className="text-sm text-[#6B7280] hover:text-[#0D2137]">
                  리포트 둘러보기
                </Link>
              </li>
              <li>
                <Link href="/write" className="text-sm text-[#6B7280] hover:text-[#0D2137]">
                  애널리스트 참여
                </Link>
              </li>
            </ul>
          ...
          <div>
            ...
            <ul className="space-y-2">
              <li>
                <Link href="#" className="text-sm text-[#6B7280] hover:text-[#0D2137]">
                  이용약관
                </Link>
              </li>
              <li>
            ...
            <ul className="space-y-2">
              <li>
                <span className="text-sm text-[#6B7280]">
                  support@independent-research.kr
                </span>
              </li>
            </ul>
          </div>
        ...
        <div className="mt-10 border-t border-[#E5E7EB] pt-6">
          ...
          <p className="mt-2 text-xs text-[#6B7280]">
            &copy; {new Date().getFullYear()} 독립리서치. All rights reserved.
          </p>
        </div>
      </div>
    </footer>
